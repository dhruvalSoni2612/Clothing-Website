...
const MenProductItems = ({products}) =>{
  ...
  <img className={css.productimage} src={products.image} alt="product"/>
  {wishlistElementFound ? <a onClick={handelRemoveWishlist}> <span className={css.wishlist}>
  <FaHeart size={25} color="red"/> </span></a> : <a onClick={handelAddToWishlist}> <span className={css.wishlist}><FaHeart size={25}/> </span></a>}
...
export default MenProductItems;